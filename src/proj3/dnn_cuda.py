...
def get_im2col_indices(x_shape, field_height, field_width, padding=1, stride=1):
    ...
    N, C, H, W = x_shape
    # assert (H +  padding - field_height) % stride == 0, "{} {} {} {}".format(H, padding, field_height, stride)
    # assert (W + padding - field_height) % stride == 0, "{} {} {} {}".format(W, padding, field_width, stride)
